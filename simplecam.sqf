...
// 2. Notification Box (Bottom Middle - TRANSPARENT)
...
_notify ctrlSetBackgroundColor [0,0,0,0]; // Transparent
...
// Note: In Follow Mode, "Pos" is Relative Offset. In Free Mode, it is World Pos.
